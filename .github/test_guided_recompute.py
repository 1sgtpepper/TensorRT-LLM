...
"""Grammar-continuation investigation for published source 17803f6c0cbe8d9fed3ccf46a295b867e3493d3e.

Uses real native requests, slot allocation, xgrammar, CUDA mask application and
native streaming results. It deliberately invokes pause/reset directly to isolate
continuation semantics. It does not execute a model or prove KV-pressure scheduling.
Run only in the fork GPU environment with matching Python/native code.
"""
